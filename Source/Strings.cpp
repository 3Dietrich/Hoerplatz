...
namespace
{
    const Texts german
    {
        ...
        "Wie weit der Pegelausgleich geht. 100 % ist der Normalfall im Raum, 141 % die Rechnung fürs Freie.",
    ...
    const Texts english
    {
        ...
        "How far the level correction goes. 100 % is the normal case in a room, 141 % the free-field maths.",
